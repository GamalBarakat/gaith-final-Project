                        ...
                        children: [
                          ...
                          Text('اسم المستخدم',
                            ...
                            style: TextStyle( color: Color(0xff2B2B2B),
                              ...
                              fontFamily: 'Tajawal',),),
                          CustomTextFormField(
                            hintText: '${updateProfileModel!.user!.name}',
                          ...
                          Text('البريد الإلكتروني',
                            ...
                            style: TextStyle( color: Color(0xff2B2B2B),
                              ...
                              fontFamily: 'Tajawal',),),
                          CustomTextFormField(
                            hintText: '${updateProfileModel!.user!.email}',
                          ...
                          Text('رقم الموبايل',
                            ...
                            style: TextStyle( color: Color(0xff2B2B2B),
                              ...
                              fontFamily: 'Tajawal',),),
                          CustomTextFormField(
                            hintText: '${updateProfileModel!.user!.phone}',
                          ...
                          Text( 'العنوان',
                            ...
                            style: TextStyle( color: Color(0xff2B2B2B),
                              ...
                              fontFamily: 'Tajawal',),),
                          CustomTextFormField(
                            hintText:  '${updateProfileModel!.user!.address}',
